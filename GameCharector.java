...
public class GameCharector {
    ...
    public static void newWindow(String title) {
        ...
        //задний фон
        Image image = new Image(GameCharector.class.getResourceAsStream("track.jpg"));
        ...
        Ninja ninja = new Ninja(RandomLogic.getVmax(),"Дорожка - 1");
        Sonic sonic = new Sonic(RandomLogic.getVmax(),"Дорожка - 2");
        FunnyMan funnyMan = new FunnyMan(RandomLogic.getVmin(),"Дорожка - 3");
        FunnyGirl funnyGirl = new FunnyGirl(RandomLogic.getVmin(),"Дорожка - 4");
        Hero hero = new Hero(RandomLogic.getVmax(),"Дорожка -6");
        FunnyMan funnyMan1 = new FunnyMan(RandomLogic.getVmin(),"Дорожка - 5");
        Sonic sonic1 = new Sonic(RandomLogic.getVmax(),"Дорожка - 7");
        Ninja ninja1 = new Ninja(RandomLogic.getVmax(),"Дорожка - 8");

        ninja.character.setTranslateY(45);
        sonic.character.setTranslateY(120);
        funnyMan.character.setTranslateY(185);
        funnyGirl.character.setTranslateY(260);
        funnyMan1.character.setTranslateY(320);
        hero.character.setTranslateY(390);
        sonic1.character.setTranslateY(460);
        ninja1.character.setTranslateY(510);
...
//todo подумать над более грамотным условием выйгрыша той или иной позиции
 ...
 //todo счетчик анимации обнуляется только после нажатия клавиши ВЫХОД. Пока не нажата операция выполняется(исправить)
        ...
        root.getChildren().addAll(ninja.character, sonic.character, funnyMan.character, funnyGirl.character,funnyMan1.character,hero.character,sonic1.character,ninja1.character, button);
